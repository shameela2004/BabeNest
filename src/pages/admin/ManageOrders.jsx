// correct version of manage orders before connecting with the backend
...
//       setOrders(data);
//       // Optional: backend could send totalPages, otherwise calculate manually
...
//   setUpdatingStatus(true);
//   try {
//     await api.put(`/AdminOrders/${selectedOrder.id}/status`, { orderStatusId: newStatusId });
//     toast.success("Order status updated!");

//     setSelectedOrder((prev) => ({ ...prev, orderStatusId: newStatusId }));
//     setOrders((prev) =>
//       prev.map((o) =>
//         o.id === selectedOrder.id ? { ...o, orderStatusId: newStatusId } : o
//       )
//     );
//   } catch (err) {
...
//     2: "bg-blue-100 text-blue-800", // shipped
...
//                   <td className="p-3 border-b font-mono">{order.orderNumber}</td>
//                   <td className="p-3 border-b">
//                     <div className="font-semibold">{order.customerName}</div>
...
//                         statusColors[order.orderStatusId] ||
...
//         >
//           <div
//             className="bg-pink-50 rounded-lg max-w-3xl w-full p-6 max-h-[90vh] overflow-y-auto shadow-lg"
...
//                         />
//                       </td>
//                       <td className="p-2 border-r font-semibold">{item.productName}</td>
//                       <td className="p-2 border-r hidden sm:table-cell">{item.categoryName}</td>
//                       <td className="p-2 border-r">₹{item.price}</td>
//                       <td className="p-2 border-r">{item.quantity}</td>
//                       <td className="p-2">₹{item.price * item.quantity}</td>
//                     </tr>
              ...
              orders.map((order) => (
                <tr key={order.id} className="hover:bg-pink-50">
                  ...
                  <td className="p-3 border-b">
                    <span
                      className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${
                        orderStatusColors[order.orderStatus] || "bg-gray-100 text-gray-800"
                      }`}
                    >
                  ...
                  <td className="p-3 border-b">{order.paymentMethod || "N/A"}</td>
                  <td className="p-3 border-b text-center space-x-2">
                    <button
                      onClick={() => setSelectedOrder(order)}
                      className="text-pink-600 hover:underline font-semibold"
